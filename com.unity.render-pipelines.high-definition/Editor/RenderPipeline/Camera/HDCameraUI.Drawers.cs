...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    partial class HDCameraUI
    {
        ...
        public static readonly CED.IDrawer SectionFrameSettings = CED.Conditional(
            ...
            { 
                if (!serialized.passThrough.boolValue && (HDAdditionalCameraData.RenderingPath)serialized.renderingPath.intValue == HDAdditionalCameraData.RenderingPath.Custom)
