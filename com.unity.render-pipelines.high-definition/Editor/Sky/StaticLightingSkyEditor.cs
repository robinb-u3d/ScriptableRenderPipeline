...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class StaticLightingSkyEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                EditorGUILayout.IntPopup(m_SkyUniqueID, m_SkyClassNames.ToArray(), m_SkyUniqueIDs.ToArray(), CoreEditorUtils.GetContent("Static Lighting Sky|Specify which kind of sky you want to use for static ambient in the referenced profile."));
            }
